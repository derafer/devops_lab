...
for i in range(ip_pairs):
    ...
    for j in range(mask_number):
        full_leng1 = format(int(ip_raw1[0]), '08b') + format(int(ip_raw1[1]), '08b') + format(int(ip_raw1[2]), '08b') + format(int(ip_raw1[3]), '08b')
        full_leng2 = format(int(ip_raw2[0]), '08b') + format(int(ip_raw2[1]), '08b') + format(int(ip_raw2[2]), '08b') + format(int(ip_raw2[3]), '08b')
        full_mask = format(int(masks[j][0]), '08b') + format(int(masks[j][1]), '08b') + format(int(masks[j][2]), '08b') + format(int(masks[j][3]), '08b')
